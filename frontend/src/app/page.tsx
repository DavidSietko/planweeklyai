  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <h2 style={{ fontSize: '1.35rem', fontWeight: 500, color: '#3b3b3b', marginBottom: '1.5rem', textAlign: 'center', maxWidth: 600, margin: '0 auto 2rem auto' }}>
        ...
        <div className={styles.sections}>
          <div className={styles.sectionBox}>
            ...
            <div style={{ marginTop: '1rem', fontWeight: 600, fontSize: '1.08rem' }}>
              Plan your weekly schedule any time.
            </div>
          </div>
          <div className={styles.sectionBox}>
            {/* Clock Icon */}
            ...
            <div style={{ marginTop: '1rem', fontWeight: 600, fontSize: '1.08rem' }}>
              Save time and energy on planning.
            </div>
          </div>
          <div className={styles.sectionBox}>
            {/* AI/Robot Icon */}
            ...
            <div style={{ marginTop: '1rem', fontWeight: 600, fontSize: '1.08rem' }}>
              Use AI to automatically sync your schedule with your Google Calendar.
            </div>
          </div>
        </div>
        <div style={{ width: '100%', textAlign: 'center', marginTop: '2.5rem' }}>
          <span style={{ fontSize: '1rem', color: '#2563eb', background: '#e0f2fe', padding: '0.5rem 1rem', borderRadius: '1rem', display: 'inline-block' }}>
